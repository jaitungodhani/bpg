...
def init(request):    
    ...
    user_data,all_user = get_user_name (request)
    all_user_name=[]
    for user in all_user:
        all_user_name.append(user.userName)
    print(all_user_name)
    ...
    return render(request, 'bpgtemplate.html',{"serviceList":serviceList,"all_user_name":all_user_name})
...
def get_user_name(request):
    ...
    all_user=UserDetail.objects.all()
    return(user_details,all_user)
